...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZW1la2FyYXBoYWVsMTMiLCJhIjoiY2x5NmxkeHBjMGJlbDJsczNmbHRrc2J3MSJ9.xusEnRv9dHjwR29KIVWm1A';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/emekaraphael13/cly7x2trc00g401png2wp7gp4',
    // style URL
    scrollZoom: false
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          (0, _alert.showAlert)('success', 'Signed up successfuly');
          ...
          break;
        case 9:
          return _context.abrupt("return", (0, _alert.showAlert)('error', 'Please provide info on all required fields'));
        case 10:
          console.log(res);
          _context.next = 16;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          break;
        case 9:
          return _context2.abrupt("return", (0, _alert.showAlert)('error', 'Please provide both email and password.'));
        case 10:
          console.log(res);
          _context2.next = 16;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          (0, _alert.showAlert)('success', 'User Logged out successfully');
          _context3.next = 11;
          break;
        case 8:
          _context3.prev = 8;
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var response, session, authorization_url;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          ...
          (0, _alert.showAlert)('error', 'No session or data found in response');
        ...
        case 10:
          ...
          if (authorization_url) {
            ...
            (0, _alert.showAlert)('error', 'Authorization URL is undefined');
          }
...
if (userDataForm) userDataForm.addEventListener("submit", function (e) {
  ...
  (0, _updateSettings.updateSettings)(form, "data").then(function () {
...
if (bookBtn) bookBtn.addEventListener("click", function (e) {
  ...
  (0, _Payment.bookTour)(tourId).then(function () {
